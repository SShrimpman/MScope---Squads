            ...
            <div class="grid w-500 rounded-xl bg-blue-500 content-center">
                ...
                <div class="bg-white2 rounded-b-xl">
                    <div class="flex justify-center space-x-2 mb-6">
                        <Button :text="'Delete'" class="text-red-600 hover:text-white2 before:bg-red-600 after:bg-red-600 py-0.5 px-3.5" @click="deleteUser(userToDelete)"/>
...
export default {
    ...
    methods: {
        deleteUser(userToDelete){
            this.$emit('userDeleted', userToDelete)
        },
        cancel(){
